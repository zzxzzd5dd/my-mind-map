...
export const getFileContent = params => {
  ...
  return http.get('/getFileContent/'+params.id)
}
 ...
 * @Desc: 获取本地配置
 */
export const createNodeData = (data = {}) => {
  return http.post('/createNodeData', data)
}

export const updateNodeData = (data = {}) => {
  return http.put('/updateNodeData', data)
}

export const deleteNodeData = (data = {}) => {
  return http.post('/deleteNodeData', data)
}
